...
function begin(config) {
    return (_a) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const firebaseSessionObj = {
            [types_2.STATE_COOKIE_NAME]: state,
        };
        yield cookies.setAndSign(types_2.FIREBASE_SESSION_COOKIE_NAME, JSON.stringify(firebaseSessionObj), {
        ...
        response.headers = Object.assign(Object.assign(Object.assign({}, response.headers), cookies.response.headers), { Location: redirectUrl, 'Cache-Control': 'private' });
...
function callback(config) {
    return function callback(_a) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const firebaseSessionFromCookie = (_b = (yield cookies.getAndVerify(types_2.FIREBASE_SESSION_COOKIE_NAME))) !== null && _b !== void 0 ? _b : '{}';
            ...
            const stateFromCookie = firebaseSessionObj[types_2.STATE_COOKIE_NAME];
            delete firebaseSessionObj[types_2.STATE_COOKIE_NAME];
            if (!stateFromCookie) {
            ...
            if (config.isEmbeddedApp) {
                cookies.deleteCookie(types_2.FIREBASE_SESSION_COOKIE_NAME);
            }
            else {
                firebaseSessionObj[types_2.SESSION_COOKIE_NAME] = session.id;
                yield cookies.setAndSign(types_2.FIREBASE_SESSION_COOKIE_NAME, JSON.stringify(firebaseSessionObj), {
            ...
            return {
                headers: (yield (0, http_1.abstractConvertHeaders)(Object.assign(Object.assign({}, cookies.response.headers), { 'Cache-Control': 'private' }), adapterArgs)),
                session,
            };
        });
    };
