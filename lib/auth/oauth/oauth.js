...
function begin(config) {
    return (_a) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        yield cookies.set(types_2.FIREBASE_SESSION_COOKIE_NAME, JSON.stringify(firebaseSessionObj), {
...
function callback(config) {
    return function callback(_a) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const firebaseSessionFromCookie = (_b = (yield cookies.get(types_2.FIREBASE_SESSION_COOKIE_NAME))) !== null && _b !== void 0 ? _b : '{}';
